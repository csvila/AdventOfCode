...
def generate_grid(depth_param, corner_param):
    # (x, y) -> geologic index, erosion level, risk
    grid = {}

    for y in range(0, corner_param[1] + 1):
        for x in range(0, corner_param[0] + 1):
...
depth, target = get_cave("input22.txt")
